...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">PAEC</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#programas">Programas</a></li>
          <li><a class="nav-link scrollto " href="#tutoriales">Tutoriales</a></li>
    ...
    <section id="Categorias" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Categorias</h2>
          <p>Explora las categorias de los articulos y software disponible en este portal.</p>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>PAEC</span></strong>. Todos los derechos reservados.
        </div>
        <div class="credits">
          Elaborado por <a href="https://soft-cronos.com/">Soft-cRONOS</a>
        </div>
      </div>
